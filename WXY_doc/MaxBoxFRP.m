function MaxBoxFRP(fid, Name,ys,yp,zs,zp,FRP)
 xp = 0;
 xs = 540;
...
fprintf(fid,', "Flags:=", "", "Color:=", "(132 132 193)", "Transparency:=", 0, "PartCoordinateSystem:=", "Global", "UDMId:=", "", "MaterialValue:=", "" & Chr(34) & "%s" & Chr(34) & "", "SolveInside:=",  true)',FRP);
